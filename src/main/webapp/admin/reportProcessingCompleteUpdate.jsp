...
<script>
	...
	function checkUpdateProcessing(num,processing){
		location.href='reportProcessingcCompleteUpdatePro.jsp?num='+num+'&processing='+processing;
	}
...
<div id="wrap">
		...
		<!-- 본문 내용 -->
		<article>
			<h1>Report Complete List</h1>
			<div class="admin_btn">
			<input type="button" value="수정완료" id="processing_update" onclick="location.href='reportCompleteList.jsp'">
			</div>
			<table id="notice">
				<tr>
					<th class="tno">No.</th>
				...
				ArrayList<ReportDTO> reportList = dao.selectReportCompleteList();
